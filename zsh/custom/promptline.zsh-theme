...
function __promptline {
  ...
  local x_bg="${wrap}48;5;23${end_wrap}"
  local x_sep_fg="${wrap}38;5;23${end_wrap}"
  local y_fg="${wrap}38;5;231${end_wrap}"
  local y_bg="${wrap}48;5;29${end_wrap}"
  local y_sep_fg="${wrap}38;5;29${end_wrap}"
  local z_fg="${wrap}38;5;231${end_wrap}"
  local z_bg="${wrap}48;5;36${end_wrap}"
  local z_sep_fg="${wrap}38;5;36${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
